...
def generate_launch_description():
    ...
    tutorial_vehicle_sensor_kit_launch_share_dir = get_package_share_directory("tutorial_vehicle_sensor_kit_launch")
    ...
    add_launch_arg(
        ...
        os.path.join(
            tutorial_vehicle_sensor_kit_launch_share_dir,
            "config",
